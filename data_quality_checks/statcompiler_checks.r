...
## Authors: Krista Steuben and Kate Wilson
##
...
ctry_codes <- read.csv(paste0(j, "/WORK/11_geospatial/10_mbg/stage_master_list.csv")) #Needs to be updated for Stage 2 and 3 countries
